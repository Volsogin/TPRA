...
public class Task2 {
    public static void main(String[] args) {
        ...
        ChessPiece[][] boardConfig = {
                ...
                {ChessPiece.QUEEN_WHITE, ChessPiece.EMPTY, ChessPiece.EMPTY, ChessPiece.BISHOP_BLACK, ChessPiece.EMPTY, ChessPiece.EMPTY, ChessPiece.EMPTY, ChessPiece.EMPTY},
                ...
                {ChessPiece.PAWN_WHITE, ChessPiece.EMPTY, ChessPiece.EMPTY, ChessPiece.QUEEN_BLACK, ChessPiece.EMPTY, ChessPiece.PAWN_WHITE, ChessPiece.EMPTY, ChessPiece.PAWN_WHITE},
        ...
        ChessBoard chessBoard = new ChessBoard(boardConfig);
        chessBoard.print();
